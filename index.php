...
<body>
  ...
  <div class="container">
    ...
    <a class="navbar-brand" href="#">
      <img src="logo.jpg" alt="Logo" width="35" height="35" class="me-2" style="color: #ffff;">
      Capture
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Make</a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Make Your Pin</a></li>
          </ul>
    ...
    <div class="container"> 
    <h1 class="text-center p-3 color-#ffff" style="color: #ffff;">CAPTURE</h1>
